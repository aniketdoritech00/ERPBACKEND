package com.doritech.PdfService.Request;
...
public class CCTVBranchInfoRequestDTO {
	...
	@NotBlank(message = "Field Associate name is required")
	...
	/* ================= CCTV RELATED OBJECTS ================= */

	@NotNull(message = "CCTV Product details are required")
	private CCTVProductDetailDTO cctvProductDetail;

	@NotNull(message = "CCTV HDD status is required")
	private List<CCTVHddStatusDTO> cctvHddStatus;

	@NotNull(message = "CCTV Camera status is required")
	private List<CCTVCameraStatusDTO> cctvCameraStatus;

	@NotNull(message = "CCTV Material details are required")
	private List<CCTVMaterialDTO> materials;

	@NotNull(message = "CCTV Staff members are required")
	private List<CCTVStaffMemberDTO> staffMembers;

	@NotNull(message = "CCTV Product Installed Status is required")
