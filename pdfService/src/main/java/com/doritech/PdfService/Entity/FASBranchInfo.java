...
public class FASBranchInfo {
	...
	public FASBranchInfo(Long id, String branchCode, Integer scheduleVisitId, LocalDate inspectionDate,
			String serviceReportNumber, String fieldAssociateName, String concernedPersonName,
			String concernedPersonDesignation, String concernedPersonPhone, String productType, String faModel,
			String noOfZones, LocalDate dateOfInstallation, String batteryVoltage, String faWorkingStatus,
			String systemConnectedThrough, String autoDialerTypePstnGsm, String autoDialerInbuiltExternal,
			String simNumber, Integer noUpdatedInAutoDialer, Boolean isPanelCleaned,
			Boolean areHootersDifficultToAccess, Boolean areSensorsCleaned, Boolean isBatteryWorking,
			Boolean isOperationExplained, Boolean isSettingDoneAsPerBank, Boolean isPanelAndSensorsCleaned,
			Boolean isPasswordChanged, String faRemarks, String customerRemarks, String estimateNo,
			String estimateProductDetails, Double estimateAmount, LocalDate estimateDate, Boolean billToBeRaised,
			String billNo, LocalDate billDate, Boolean isInvoicePaymentFollowed, String paymentRemarks, String status,
			String createdBy, LocalDateTime createdAt, LocalDateTime updatedAt, String pdfFilePath,
			List<FASHardwareItem> hardwareItems, List<FASDialerContact> dialerContacts, List<FASMaterial> fasMaterials,
			List<FASStaffMember> staffMembers, List<FASBranchDocument> fasBranchDocuments) {
	...
	public List<FASHardwareItem> getHardwareItems() {
		return hardwareItems;
	}

	public void setHardwareItems(List<FASHardwareItem> hardwareItems) {
		this.hardwareItems = hardwareItems;
	}

	public List<FASDialerContact> getDialerContacts() {
		return dialerContacts;
	}

	public void setDialerContacts(List<FASDialerContact> dialerContacts) {
		this.dialerContacts = dialerContacts;
	}

	public List<FASMaterial> getFasMaterials() {
		return fasMaterials;
	}

	public void setFasMaterials(List<FASMaterial> fasMaterials) {
		this.fasMaterials = fasMaterials;
	}

	public List<FASStaffMember> getStaffMembers() {
		return staffMembers;
	}

	public void setStaffMembers(List<FASStaffMember> staffMembers) {
		this.staffMembers = staffMembers;
	}
	...
	public List<FASBranchDocument> getFasBranchDocuments() {
		return fasBranchDocuments;
	}

	public void setFasBranchDocuments(List<FASBranchDocument> fasBranchDocuments) {
		this.fasBranchDocuments = fasBranchDocuments;
	}
}