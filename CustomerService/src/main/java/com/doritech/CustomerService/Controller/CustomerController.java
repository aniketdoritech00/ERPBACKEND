...
public class CustomerController {
	...
	public ResponseEntity deleteCustomer(@RequestBody List<Integer> ids,
			@RequestHeader("X-User-Id") String userId,
			HttpServletRequest httpRequest) {
		logger.info("Delete Customer API hit by user {} for ids {}", userId,
				ids);
	...
	public ResponseEntity getCustomerByHierarchy(
			@PathVariable Integer customerId) {
		logger.info(
				"API called: getCustomersByCustomerHierarchy with customerId {}",
				customerId);
