...
public class CustomerEntityTypeResponse {
    ...
    public Integer getCustEntityId() { return custEntityId; }
    public void setCustEntityId(Integer custEntityId) { this.custEntityId = custEntityId; }
