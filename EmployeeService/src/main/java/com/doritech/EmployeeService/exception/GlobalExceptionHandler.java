...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity handlePasswordPolicyException(
        ...
        return buildErrorResponse(ex.getMessage(), ex.getErrors(), HttpStatus.BAD_REQUEST, request);
    }
    ...
    public ResponseEntity handleNotFound(ConfigDataResourceNotFoundException ex, HttpServletRequest request) {
        return buildErrorResponse("Data Not found", ex.getMessage(), HttpStatus.NOT_FOUND, request);
    }

    @ExceptionHandler(EmployeeNotFoundException.class)
    public ResponseEntity handleEmployeeNotFound(EmployeeNotFoundException ex, HttpServletRequest request) {
        return buildErrorResponse(ex.getMessage(), null, HttpStatus.NOT_FOUND, request);
    }

    @ExceptionHandler(AttendanceNotFoundException.class)
    public ResponseEntity handleAttendanceNotFound(AttendanceNotFoundException ex, HttpServletRequest request) {
        return buildErrorResponse(ex.getMessage(), null, HttpStatus.NOT_FOUND, request);
    }

    @ExceptionHandler(AlreadyCheckedOutException.class)
    public ResponseEntity handleAlreadyCheckedOut(AlreadyCheckedOutException ex, HttpServletRequest request) {
        return buildErrorResponse(ex.getMessage(), null, HttpStatus.CONFLICT, request);
    }

    @ExceptionHandler(MultipartException.class)
    public ResponseEntity handleMultipartException(MultipartException ex, HttpServletRequest request) {
        return buildErrorResponse("File upload error. Please check file format.",
    ...
    public ResponseEntity handleMissingFile(MissingServletRequestPartException ex, HttpServletRequest request) {
    ...
    public ResponseEntity handleDataIntegrityViolation(DataIntegrityViolationException ex, HttpServletRequest request) {
        ...
        return new ResponseEntity(userMessage, HttpStatus.BAD_REQUEST.value(), response);
    }
    ...
    public ResponseEntity handleTransactionException(TransactionSystemException ex, HttpServletRequest request) {
        ...
        return buildErrorResponse("Unable to process request. Please try again.",
                root != null ? root.getMessage() : ex.getMessage(),
                HttpStatus.INTERNAL_SERVER_ERROR, request);
    }

    @ExceptionHandler(ConstraintViolationException.class)
    public ResponseEntity handleConstraintException(ConstraintViolationException ex, HttpServletRequest request) {
    ...
    public ResponseEntity handleRuntimeException(RuntimeException ex, HttpServletRequest request) {
        return buildErrorResponse(ex.getMessage(), null, HttpStatus.INTERNAL_SERVER_ERROR, request);
    }
